...
hetzner cloud, provisioned with terraform, configured with nixos. everything declarative, everything reproducible. if a server explodes i can just... make another one.
...
**attic** - a nix binary cache connected to a s3 bucket
